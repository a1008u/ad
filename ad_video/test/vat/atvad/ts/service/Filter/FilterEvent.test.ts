import { FilterEvent } from "../../../../../../src/vat/atvad/ts/service/Filter/FilterEvent";
import { FilterPlayMode } from "../../../../../../src/vat/atvad/ts/service/Filter/FilterPlayMode";
import { ImpService } from "../../../../../../src/vat/atvad/ts/service/ImpService";
...
describe('videoStateChangeの確認(play -> pause状態に変更)', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<video playxxx="play" id="atvVideo" playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video>';
  });
...
describe('videoStateChangeの確認(pause -> play状態に変更)', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<video playxxx="pause" id="atvVideo" playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video>';
  });
...
describe('videoStateChangeの確認(playxxxが存在しない動作)', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<video id="atvVideo" videoStart playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video>';
  });
...
describe('showFilterの確認', () => {
  ...
  beforeEach(() => {
    ...
    <div id="test">
      <video playxxx="play" id="atvVideo" playsinline="playsinline" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" width="640"></video>
    </div>`;
  });
  ...
  test('正常確認', async () => {
    // mock
    jest.mock('../../../../../../src/vat/atvad/ts/service/Filter/FilterEvent');
