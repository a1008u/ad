import { EventViewThrough } from "../../../../../src/vat/atvad/ts/service/EventViewThrough";
...
describe('viewThroughActionのチェック', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<div><video id="atvVideo" playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video></div>';
