import { MessageEvent } from '../../../../../src/vat/atvad/ts/service/MessageEvent';
...
describe('ckAndExeActionの確認', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<video id="atvVideo" playxxx="pause" playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video>';
    jest.spyOn(VideoAction, 'pauseAction').mockImplementation();
...
describe('ckAndExeActionの確認', () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = '<video id="atvVideo" playxxx="play" playsinline="playsinline" style="cursor:pointer;" muted="" src="http://localhost:3000/vat/atvad/mp4/ba1.mp4" loop="true" ___filter="off" width="640"></video>';
    jest.spyOn(VideoAction, 'pauseAction').mockImplementation();
    jest.spyOn(VideoAction, 'playAction').mockImplementation();
    jest.spyOn(ImpService, 'execImp').mockImplementation();
  });
