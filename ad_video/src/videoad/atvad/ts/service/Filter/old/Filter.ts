...
export namespace Filter {
  ...
  async function mkFilterElement(
    ...
    const objectElement: HTMLObjectElement = mkObjElement(
      svgData,
      videoTag,
      playMode
    );
  ...
  export async function execFil(videoTag: HTMLVideoElement, playMode: string) {
    const divElementFilter: HTMLDivElement = await mkFilterElement(
      videoTag,
      getFilter,
      playMode
    );
   ...
   * @param playMode
   */
  export async function execFilnotAnimation(
    videoTag: HTMLVideoElement,
    playMode: string
  ) {
    const divElementFilter: HTMLDivElement = await mkFilterElement(
      videoTag,
      getFilterNotAnimation,
      playMode
    );
    const svgElement = divElementFilter.firstElementChild.firstElementChild;
    svgElement.setAttribute(
